...
export default function Dashboard() {
  ...
  const mockNearbyUsers = [
    { id: 1, name: "Ayşe Demir", bloodType: "A Rh+", location: "Kadıköy, İstanbul", distance: "1 km", lastActive: "5 dk önce" },
    { id: 2, name: "Mehmet Kaya", bloodType: "B Rh-", location: "Üsküdar, İstanbul", distance: "3 km", lastActive: "10 dk önce" },
    { id: 3, name: "Ali Yılmaz", bloodType: "0 Rh+", location: "Beşiktaş, İstanbul", distance: "5 km", lastActive: "15 dk önce" }
  ];
  ...
  const displayedRequests = bloodRequests.slice(startIndex, startIndex + ITEMS_PER_PAGE);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Kan bağışı ile hayat kurtarmaya devam edin</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
              <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <h2 className="text-lg font-medium text-gray-900 dark:text-white">Kan İhtiyaçları</h2>
                <button
              ...
              <div className="p-6">
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-600 dark:text-gray-400">Henüz kan talebi bulunmuyor.</p>
                  </div>
                ) : (
